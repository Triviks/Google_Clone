...
function SearchPageHeader({ searchTerm, onSearchTermChange }) {
    ...
    return (
        <>
            <header className='container-fluid px-4 pt-4 search-head nav-tabs'>
                <div className='d-flex justify-content-start gap-5 align-items-center'>
                    <div className="logo">
                        <img src={logo_color} width={150} />
                    </div>
                    <form className='d-flex align-items-center w-50 gap-3'>
                        <input type="text" className='w-100 ms-2 ps-3' value={searchTerm} onChange={handleChange} />
                        <svg className="voice-search" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className='page_options gap-3 d-flex  justify-content-between'>
                    <ul className='nav gap-4 list-unstyled' id='options'>
                    ...
                    <ul className='d-flex list-unstyled justify-content-between' id='tools'>
                        <li>Tools</li>
                        <li>Safe Search</li>
                    </ul>
